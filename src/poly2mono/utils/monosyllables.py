...
VERBS = [
    ...
    "πιώ", "πιείς", "πιής", "πίης", "πιεί", "πίει", "πιή", "πίη", "πιούν", "πιές",
...
OTHERS = [
    ...
    "πλήν",
    # Interjections
    "άχ", "φεύ", "ώχ", "τάκ", "κοί", "λί", "λά",
    "βού", "μπού",
    "μπά", "μπλούμ", "κράκ", "κούτ", "μπρόμ",
    "ούχ", "γρού", "γκρού", "ούφ", "μπούφ", "πάφ",
    "γού", "γούβ", "γκού", "ντούκ",
    "κρού", "χρού",
    "χόπ", "χάπ",
    "γρύ", "γρί",
...
TRANSLITERATIONS = [
    ...
    # FR
    "πρί", "φίξ", "ίλ", "ντόν", "βούζ", "πόντ", "νό", "μαί",
    # TR
    "βέ",
    # EN
    "άιλς", "όβ", "δέμ", "κλερκ", "άντ", "στόπ", "ώκ",
    # LA
    "έτ", "σούμ", "νός",
    # DE
    "ντί", "ντάς", "ίστ",
    # OTHERS
    "βάζ", "νέ", "χόζ", "λάχ", "βάρ", "τσόκ",
]
